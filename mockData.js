const mockData = (() => {
  ...
  const cityOptions = [
    {
      ...
      user_pin: { x: 48, y: 54, label: "你在杨浦滨江附近" }
    },
    {
      id: "beijing",
      name: "北京",
      shortName: "北京",
      areaName: "五道口",
      center_lat: 39.993128,
      center_lng: 116.337709,
      user_pin: { x: 46, y: 52, label: "你在五道口附近" }
    },
    {
      id: "guangzhou",
      name: "广州",
      shortName: "广州",
      areaName: "天河体育中心",
      center_lat: 23.134044,
      center_lng: 113.326793,
      user_pin: { x: 51, y: 55, label: "你在天河附近" }
    },
    {
      id: "chengdu",
      name: "成都",
      shortName: "成都",
      areaName: "春熙路",
      center_lat: 30.657438,
      center_lng: 104.080989,
      user_pin: { x: 49, y: 53, label: "你在春熙路附近" }
    }
  ];
  ...
  const pois = [
    ["poi_001", "Seoul Bowl 韩式简餐", "餐厅", "韩餐", 0.8, 20, 4.6, 12, "双人套餐立减 ¥30", 7, 92, 58, 36, ["韩餐", "豆腐汤", "轻松聊天", "适合1v1"]],
    ["poi_002", "Korean Bowl", "餐厅", "韩餐", 0.9, 18, 4.5, 5, "双人石锅饭套餐 ¥160", 5, 86, 70, 50, ["韩餐", "低等待", "快吃", "低压力"]],
    ["poi_003", "Little Sheep Hotpot", "餐厅", "火锅", 1.3, 32, 4.7, 24, "四人火锅拼桌套餐 ¥440", 10, 96, 42, 60, ["火锅", "多人局", "拼桌", "热闹"]],
    ["poi_004", "UCLA Sunset Cafe", "咖啡", "咖啡", 0.6, 14, 4.8, 3, "第二杯半价", 4, 74, 26, 32, ["咖啡", "学习", "安静陪伴", "轻社交"]],
    ["poi_005", "Echo KTV", "KTV", "KTV", 1.1, 28, 4.4, 8, "3 小时欢唱券 ¥495", 8, 91, 18, 66, ["KTV", "唱歌", "多人热闹", "学生"]],
    ["poi_006", "Village Tap Bar", "酒吧", "酒吧", 1.0, 26, 4.3, 0, "双人饮品券 ¥110", 5, 82, 55, 76, ["酒吧", "小酌", "喝酒", "认识新朋友"]],
    ["poi_007", "Late Night Skewer", "夜宵", "烧烤", 1.5, 16, 4.5, 12, "夜宵双人串串 ¥145", 6, 84, 82, 28, ["夜宵", "烧烤", "低预算", "小组"]],
    ["poi_008", "Quest Board Game", "桌游", "聚会桌游", 1.0, 18, 4.6, 0, "四人桌游券 ¥240", 3, 66, 66, 38, ["桌游", "破冰", "周末", "小组"]],
    ["poi_009", "Mochi Lab", "咖啡", "甜品", 0.7, 12, 4.7, 4, "甜品双拼 ¥75", 3, 62, 66, 18, ["甜品", "探店", "拍照", "周末"]],
    ["poi_010", "Ramen Corner", "餐厅", "日料", 0.5, 19, 4.4, 15, "拉面加小食 ¥105", 2, 56, 23, 45, ["日料", "快吃", "安静陪伴"]],
    ["poi_011", "BCD Tofu House", "餐厅", "韩餐", 1.2, 22, 4.6, 16, "双人豆腐汤套餐 ¥190", 6, 88, 76, 38, ["韩餐", "豆腐汤", "轻松聊天"]],
    ["poi_012", "Northern Dumpling", "餐厅", "中餐", 0.9, 17, 4.3, 9, "双人饺子套餐 ¥140", 3, 61, 47, 42, ["中餐", "低预算", "快吃"]],
    ["poi_013", "Sushi West", "餐厅", "日料", 1.4, 31, 4.6, 14, "双人寿司套餐 ¥260", 4, 72, 78, 64, ["日料", "精致", "1v1"]],
    ["poi_014", "Thai Basil", "餐厅", "东南亚菜", 1.1, 24, 4.4, 10, "双人冬阴功套餐 ¥210", 4, 69, 35, 72, ["东南亚", "探店", "轻松聊天"]],
    ["poi_015", "Burger Study", "餐厅", "美式", 0.4, 15, 4.2, 6, "汉堡套餐 ¥70", 2, 52, 50, 24, ["快吃", "学生", "低预算"]],
    ["poi_016", "Pasta Lab", "餐厅", "西餐", 1.0, 27, 4.5, 17, "双人意面套餐 ¥245", 3, 63, 40, 82, ["西餐", "拍照", "轻社交"]],
    ["poi_017", "Powell Coffee", "咖啡", "咖啡", 0.5, 10, 4.5, 2, "咖啡甜点 ¥60", 5, 78, 61, 23, ["咖啡", "学习", "安静陪伴"]],
    ["poi_018", "Diddy Riese", "咖啡", "甜品", 0.6, 9, 4.7, 7, "冰淇淋曲奇 ¥30", 4, 76, 72, 22, ["甜品", "探店", "拍照"]],
    ["poi_019", "Espresso Corner", "咖啡", "咖啡", 1.2, 13, 4.4, 4, "手冲咖啡券 ¥40", 3, 58, 30, 78, ["咖啡", "工作", "安静"]],
    ["poi_020", "Study Tea House", "咖啡", "奶茶", 0.8, 11, 4.3, 5, "双人奶茶 ¥50", 4, 68, 86, 55, ["奶茶", "学习", "安静陪伴"]],
    ["poi_021", "Sing Room KTV", "KTV", "KTV", 1.4, 30, 4.2, 13, "小包 2 小时 ¥345", 6, 83, 14, 54, ["KTV", "唱歌", "多人热闹"]],
    ["poi_022", "Campus Karaoke", "KTV", "KTV", 1.6, 25, 4.3, 6, "晚场欢唱 ¥295", 5, 80, 20, 78, ["KTV", "学生", "多人局"]],
    ["poi_023", "LiveMic KTV", "KTV", "KTV", 1.8, 35, 4.5, 11, "四人欢唱套餐 ¥545", 4, 75, 12, 24, ["KTV", "设备好", "多人热闹"]],
    ["poi_024", "Bar 404", "酒吧", "酒吧", 1.2, 32, 4.4, 0, "双人鸡尾酒 ¥140", 5, 81, 36, 88, ["酒吧", "小酌", "认识新朋友"]],
    ["poi_025", "Low Proof Lab", "酒吧", "酒吧", 1.5, 29, 4.6, 0, "低酒精饮品券 ¥120", 4, 73, 67, 85, ["酒吧", "低压力", "下班后"]],
    ["poi_026", "Jazz Patio", "酒吧", "爵士酒吧", 1.7, 36, 4.7, 5, "Live 双人座 ¥245", 3, 70, 88, 74, ["爵士", "安静陪伴", "小酌"]],
    ["poi_027", "Escape Archive", "桌游", "密室", 1.1, 42, 4.6, 0, "四人密室券 ¥640", 3, 67, 74, 28, ["密室", "周末", "小组"]],
    ["poi_028", "Switch House", "桌游", "游戏馆", 1.3, 20, 4.4, 0, "双人游戏券 ¥125", 3, 60, 84, 48, ["游戏", "破冰", "小组"]],
    ["poi_029", "Midnight Congee", "夜宵", "夜宵", 1.0, 14, 4.5, 5, "夜宵粥品双人餐 ¥110", 4, 71, 51, 90, ["夜宵", "深夜", "安静陪伴"]],
    ["poi_030", "Crispy Chicken Club", "夜宵", "炸鸡", 1.4, 18, 4.3, 9, "炸鸡啤酒双人券 ¥155", 4, 69, 79, 92, ["夜宵", "炸鸡", "聊天"]],
  ...
  const matchPlans = [
    ["match_001", "user_027", "poi_001", "poi_002", 89, "今晚 18:30", "你们都想今晚吃韩餐，预算都在 ¥100 左右，并且都选择轻松聊天模式。"],
  ...
  const replanningEvents = [
    ["event_001", "match_001", "waiting_time_change", "等待时间 12 分钟", "等待时间 35 分钟", "18:12", "检测到原餐厅等待时间从 12 分钟上升到 35 分钟。为了满足低等待和轻松成局需求，AI 推荐切换到 Korean Bowl，人均 ¥90，等待约 5 分钟。", "poi_002", "今晚 18:40"],
